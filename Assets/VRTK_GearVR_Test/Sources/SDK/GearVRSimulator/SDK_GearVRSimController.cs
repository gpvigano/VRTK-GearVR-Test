// GazeSimulator Controller|SDK_GazeSimulator|003
namespace VRTK
{
    using UnityEngine;
    ...
    /// <summary>
    /// The GazeSim Controller SDK script provides functions to help simulate VR controllers.
    /// </summary>
    [SDK_Description(typeof(SDK_GearVRSimSystem))]
    public class SDK_GearVRSimController : SDK_BaseController
    {
        ...
        {
            {"TouchpadPress", KeyCode.Mouse0 },
            {"ButtonTwo", KeyCode.Backspace },
            {"StartMenu", KeyCode.F },
        };

        public static string GAZE_CONTROLLER_NAME = "Neck/Camera/GazeController";
        ...
        public override GameObject GetControllerByIndex(uint index, bool actual = false)
        {
            ...
            {
                case 1:
                    return (sdkManager != null && !actual ? sdkManager.scriptAliasRightController : (gazeController != null ? gazeController.gameObject : null));
                default:
                    return null;
            }
        }
        ...
        public override GameObject GetControllerRightHand(bool actual = false)
        {
            ...
            // if the controller cannot be found with default settings, try finding it below the InputGazeSimulator by name
        ...
        {
            return controllerReference.scriptAlias.transform.parent.Find("Anchor").gameObject;
        }
        ...
        public override Vector3 GetVelocity(VRTK_ControllerReference controllerReference)
        {
            ...
            {
                case 1:
                    return (gazeController != null ? gazeController.GetVelocity() : Vector3.zero);
                default:
                    return Vector3.zero;
            }
        }
        ...
        {
            if(!keyMappings.ContainsKey(keyMapping))
            {
                return false;
            }
