// GazeSimulator Boundaries|SDK_GazeSimulator|004
namespace VRTK
{
    using UnityEngine;

    /// <summary>
    /// The GazeSim Boundaries SDK script provides dummy functions for the play area boundaries.
    /// </summary>
    [SDK_Description(typeof(SDK_GearVRSimSystem))]
    public class SDK_GearVRSimBoundaries : SDK_BaseBoundaries
    {
