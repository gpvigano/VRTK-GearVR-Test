// GazeSimulator Headset|SDK_GazeSimulator|002
namespace VRTK
{
    using UnityEngine;
    ...
    /// <summary>
    /// The GazeSim Headset SDK script  provides dummy functions for the headset.
    /// </summary>
    [SDK_Description(typeof(SDK_GearVRSimSystem))]
    public class SDK_GearVRSimHeadset : SDK_BaseHeadset
    {
        ...
        {
            return CleanPropertyString("gearvrsimulator");
        }
